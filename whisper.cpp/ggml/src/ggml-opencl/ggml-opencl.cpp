...
// ============================================================================
// macOS OpenCL 1.2 compatibility shims
// Apple's OpenCL is frozen at 1.2 and missing many 2.0/3.0 features
// ============================================================================

// Profiling constant
#ifndef CL_PROFILING_COMMAND_COMPLETE
#define CL_PROFILING_COMMAND_COMPLETE CL_PROFILING_COMMAND_END
#endif

// SVM (Shared Virtual Memory) - OpenCL 2.0 feature not available on macOS
#ifdef __APPLE__
...
#endif
#ifndef CL_DEVICE_SVM_FINE_GRAIN_BUFFER
#define CL_DEVICE_SVM_FINE_GRAIN_BUFFER (1 << 1)
#endif
#ifndef CL_DEVICE_SVM_FINE_GRAIN_SYSTEM
#define CL_DEVICE_SVM_FINE_GRAIN_SYSTEM (1 << 2)
#endif
#ifndef CL_DEVICE_SVM_ATOMICS
#define CL_DEVICE_SVM_ATOMICS (1 << 3)
#endif

// Vector types - macOS OpenCL headers don't define cl_half4
#ifdef __APPLE__
#ifndef cl_half4
typedef cl_half __attribute__((ext_vector_type(4))) cl_half4;
#endif
#ifndef cl_half8
typedef cl_half __attribute__((ext_vector_type(8))) cl_half8;
#endif
#ifndef cl_half16
typedef cl_half __attribute__((ext_vector_type(16))) cl_half16;
#endif
#endif
