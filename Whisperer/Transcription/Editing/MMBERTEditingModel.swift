...
struct MMBERTCalibrationTable: Sendable {
    ...
    static let measured = MMBERTCalibrationTable(cells: [
        "en/append/ALL": Cell(threshold: 0.9992, enabled: false, precision: 0.9607843137254902, support: 153, precisionLCB95: 0.9240706802100422),
        "en/append/NONE": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/append/a": Cell(threshold: 0.991, enabled: true, precision: 0.9090909090909091, support: 44, precisionLCB95: 0.8039215031874395),
        "en/append/about": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        ...
        "en/append/an": Cell(threshold: 0.9835, enabled: true, precision: 1.0, support: 10, precisionLCB95: 0.7411344491069477),
        "en/append/any": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/append/are": Cell(threshold: 0.9935, enabled: true, precision: 1.0, support: 13, precisionLCB95: 0.7941833348134493),
        "en/append/as": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/append/at": Cell(threshold: 0.9965, enabled: false, precision: 1.0, support: 5, precisionLCB95: 0.5492802716530588),
        ...
        "en/append/can": Cell(threshold: 0.3, enabled: false, precision: 0.5, support: 2, precisionLCB95: 0.025320565519103607),
        "en/append/could": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/append/do": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/append/does": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/append/first": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/append/for": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 4, precisionLCB95: 0.4728708045015879),
        ...
        "en/append/in": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/append/into": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/append/is": Cell(threshold: 0.85, enabled: true, precision: 1.0, support: 16, precisionLCB95: 0.8292502770175191),
        "en/append/it": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 2, precisionLCB95: 0.22360679774997896),
        ...
        "en/append/more": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        ...
        "en/append/of": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/append/on": Cell(threshold: 0.3, enabled: false, precision: 0.0, support: 6, precisionLCB95: 0.0),
        ...
        "en/append/out": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        ...
        "en/append/so": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        ...
        "en/append/that": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/append/the": Cell(threshold: 0.9955, enabled: true, precision: 0.797752808988764, support: 89, precisionLCB95: 0.7149876921591852),
        ...
        "en/append/to": Cell(threshold: 0.9775, enabled: true, precision: 1.0, support: 9, precisionLCB95: 0.7168711644368865),
        ...
        "en/append/were": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        ...
        "en/append/with": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        ...
        "en/case/ALL": Cell(threshold: 0.9999, enabled: false, precision: 0.9081632653061225, support: 196, precisionLCB95: 0.866858151369841),
        "en/case/CAP": Cell(threshold: 0.52, enabled: true, precision: 0.6693440428380187, support: 747, precisionLCB95: 0.639898433569547),
        "en/case/LOWER": Cell(threshold: 0.51, enabled: true, precision: 0.75, support: 144, precisionLCB95: 0.6835877011512951),
        "en/case/UPPER": Cell(threshold: 0.9975, enabled: false, precision: 0.8, support: 5, precisionLCB95: 0.3425916819988613),
        "en/disf/DISF": Cell(threshold: 0.31, enabled: true, precision: 0.5619967793880838, support: 621, precisionLCB95: 0.5282750759538746),
        "en/error/ERROR": Cell(threshold: 0.47, enabled: true, precision: 0.713641488162345, support: 3548, precisionLCB95: 0.7008896920007015),
        "en/merge/ALL": Cell(threshold: 0.99, enabled: false, precision: 1.0, support: 12, precisionLCB95: 0.7790778080544442),
        "en/merge/MERGE_HYPHEN": Cell(threshold: 0.59, enabled: false, precision: 0.5, support: 6, precisionLCB95: 0.15316111797522317),
        "en/merge/MERGE_SPACE": Cell(threshold: 0.99, enabled: true, precision: 1.0, support: 9, precisionLCB95: 0.7168711644368865),
        "en/merge/NONE": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/merge/SPLIT": Cell(threshold: 0.3, enabled: false, precision: 0.5, support: 2, precisionLCB95: 0.025320565519103607),
        "en/para/ALL": Cell(threshold: 0.9995, enabled: false, precision: 0.8333333333333334, support: 36, precisionLCB95: 0.6973225763734243),
        "en/para/LIST_ITEM": Cell(threshold: 0.3, enabled: true, precision: 1.0, support: 11, precisionLCB95: 0.7615958096191473),
        "en/para/NONE": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/para/PARA_BREAK": Cell(threshold: 0.9985, enabled: true, precision: 0.75, support: 28, precisionLCB95: 0.5812722595884942),
        "en/para/PARA_BREAK/browser": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 3, precisionLCB95: 0.3684031498640387),
        "en/para/PARA_BREAK/chat": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 5, precisionLCB95: 0.5492802716530588),
        "en/para/PARA_BREAK/editor": Cell(threshold: 0.3, enabled: true, precision: 1.0, support: 6, precisionLCB95: 0.6069622310029172),
        "en/para/PARA_BREAK/messaging": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/para/PARA_BREAK/unknown": Cell(threshold: 0.3, enabled: false, precision: 0.42105263157894735, support: 38, precisionLCB95: 0.28483332652215776),
        "en/punct/!": Cell(threshold: 0.9515, enabled: false, precision: 0.8, support: 5, precisionLCB95: 0.3425916819988613),
        "en/punct/,": Cell(threshold: 0.99995, enabled: false, precision: 0.8916666666666667, support: 120, precisionLCB95: 0.8332881874392384),
        "en/punct/.": Cell(threshold: 0.3, enabled: true, precision: 0.7703703703703704, support: 1080, precisionLCB95: 0.7483216472405858),
        "en/punct/:": Cell(threshold: 0.95, enabled: false, precision: 1.0, support: 10, precisionLCB95: 0.7411344491069477),
        "en/punct/;": Cell(threshold: 0.9965, enabled: false, precision: 1.0, support: 7, precisionLCB95: 0.6518363448688391),
        "en/punct/?": Cell(threshold: 0.88, enabled: true, precision: 0.8181818181818182, support: 22, precisionLCB95: 0.6309088656744317),
        "en/punct/ALL": Cell(threshold: 0.99995, enabled: false, precision: 0.9357326478149101, support: 389, precisionLCB95: 0.9113932366768417),
        "en/punct/NONE": Cell(threshold: 0.9905, enabled: false, precision: 0.6, support: 15, precisionLCB95: 0.3595652102176539),
        ...
        "en/repl/ALL": Cell(threshold: 0.9992, enabled: false, precision: 0.9666666666666667, support: 60, precisionLCB95: 0.8987641050758384),
        "en/repl/CONTRACT": Cell(threshold: 0.7, enabled: false, precision: 0.4375, support: 16, precisionLCB95: 0.22669156846628724),
        ...
        "en/repl/VERB_3SG": Cell(threshold: 0.999, enabled: true, precision: 0.9117647058823529, support: 34, precisionLCB95: 0.7874661287656592),
        "en/repl/VERB_ING": Cell(threshold: 0.3, enabled: false, precision: 0.25, support: 4, precisionLCB95: 0.012741455098566192),
        "en/repl/VERB_PAST": Cell(threshold: 0.3, enabled: false, precision: 0.8, support: 5, precisionLCB95: 0.3425916819988613),
        "en/repl/about": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        ...
        "en/repl/an": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/repl/and": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/repl/another": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/repl/are": Cell(threshold: 0.98, enabled: false, precision: 0.6, support: 5, precisionLCB95: 0.1892553774377708),
        "en/repl/asked": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/repl/at": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/repl/but": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/repl/changed": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/repl/claude": Cell(threshold: 0.3, enabled: false, precision: 0.3333333333333333, support: 3, precisionLCB95: 0.016952427508441496),
        "en/repl/click": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/repl/create": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/repl/detail": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 2, precisionLCB95: 0.22360679774997896),
        ...
        "en/repl/don't": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 2, precisionLCB95: 0.22360679774997896),
        ...
        "en/repl/for": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        ...
        "en/repl/i'm": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        ...
        "en/repl/indicate": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/repl/is": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/repl/issues": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/repl/it's": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/repl/iterations": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/repl/let's": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        ...
        "en/repl/make": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/repl/making": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/repl/many": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        ...
        "en/repl/of": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        ...
        "en/repl/see": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        ...
        "en/repl/that's": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/repl/the": Cell(threshold: 0.9595, enabled: false, precision: 1.0, support: 8, precisionLCB95: 0.6876560219336321),
        "en/repl/these": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/repl/to": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 2, precisionLCB95: 0.22360679774997896),
        ...
        "en/repl/use": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 4, precisionLCB95: 0.4728708045015879),
        ...
        "en/repl/were": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 2, precisionLCB95: 0.22360679774997896),
        "en/repl/weren't": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/repl/what": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        "en/repl/where": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 2, precisionLCB95: 0.22360679774997896),
        "en/repl/which": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/repl/wispr": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        ...
        "he/case/ALL": Cell(threshold: 0.9865, enabled: false, precision: 1.0, support: 9, precisionLCB95: 0.7168711644368865),
        "he/case/CAP": Cell(threshold: 0.3, enabled: false, precision: 0.2, support: 5, precisionLCB95: 0.010206218313011496),
        "he/case/LOWER": Cell(threshold: 0.71, enabled: false, precision: 0.9565217391304348, support: 23, precisionLCB95: 0.8097960333079883),
        "he/case/UPPER": Cell(threshold: 0.3, enabled: false, precision: 0.0, support: 2, precisionLCB95: 0.0),
        "he/disf/DISF": Cell(threshold: 0.962, enabled: false, precision: 0.42105263157894735, support: 19, precisionLCB95: 0.22972091932616245),
        "he/error/ERROR": Cell(threshold: 0.9997, enabled: false, precision: 0.5185185185185185, support: 27, precisionLCB95: 0.3469716996903496),
        "he/merge/ALL": Cell(threshold: 0.73, enabled: false, precision: 0.25, support: 4, precisionLCB95: 0.012741455098566192),
        "he/merge/MERGE_HYPHEN": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "he/merge/MERGE_SPACE": Cell(threshold: 0.3, enabled: false, precision: 0.0, support: 2, precisionLCB95: 0.0),
        "he/merge/NONE": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "he/merge/SPLIT": Cell(threshold: 0.3, enabled: false, precision: 0.3333333333333333, support: 3, precisionLCB95: 0.016952427508441496),
        "he/para/ALL": Cell(threshold: 0.99999, enabled: false, precision: 0.8125, support: 16, precisionLCB95: 0.5834277192938473),
        ...
        "he/para/PARA_BREAK": Cell(threshold: 0.99999, enabled: true, precision: 0.8125, support: 16, precisionLCB95: 0.5834277192938473),
        ...
        "he/para/PARA_BREAK/unknown": Cell(threshold: 0.99999, enabled: true, precision: 0.8125, support: 16, precisionLCB95: 0.5834277192938473),
        "he/punct/!": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "he/punct/,": Cell(threshold: 0.62, enabled: false, precision: 0.16, support: 75, precisionLCB95: 0.09499788275307035),
        "he/punct/.": Cell(threshold: 0.9875, enabled: false, precision: 0.39473684210526316, support: 38, precisionLCB95: 0.26138431976812754),
        "he/punct/:": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "he/punct/;": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "he/punct/?": Cell(threshold: 0.51, enabled: false, precision: 0.6666666666666666, support: 6, precisionLCB95: 0.2713383725197525),
        "he/punct/ALL": Cell(threshold: 0.9715, enabled: false, precision: 0.2773109243697479, support: 119, precisionLCB95: 0.21040072296124615),
        "he/punct/NONE": Cell(threshold: 0.9775, enabled: false, precision: 0.3333333333333333, support: 21, precisionLCB95: 0.1681758233914966),
        "he/punct/—": Cell(threshold: 0.76, enabled: false, precision: 0.5, support: 6, precisionLCB95: 0.15316111797522317),
        "he/punct/…": Cell(threshold: 0.3, enabled: false, precision: 0.2, support: 5, precisionLCB95: 0.010206218313011496),
        ...
        "ru/case/ALL": Cell(threshold: 0.9995, enabled: false, precision: 0.673469387755102, support: 49, precisionLCB95: 0.5471961517777497),
        "ru/case/CAP": Cell(threshold: 0.9945, enabled: true, precision: 0.5857142857142857, support: 70, precisionLCB95: 0.480387112712051),
        "ru/case/LOWER": Cell(threshold: 0.3, enabled: false, precision: 0.6, support: 5, precisionLCB95: 0.1892553774377708),
        "ru/case/UPPER": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "ru/disf/DISF": Cell(threshold: 0.47, enabled: false, precision: 0.42105263157894735, support: 19, precisionLCB95: 0.22972091932616245),
        "ru/error/ERROR": Cell(threshold: 0.9997, enabled: true, precision: 0.7872340425531915, support: 94, precisionLCB95: 0.7060391268919364),
        ...
        "ru/para/ALL": Cell(threshold: 0.99995, enabled: false, precision: 0.7777777777777778, support: 9, precisionLCB95: 0.45035835049338985),
        ...
        "ru/para/PARA_BREAK": Cell(threshold: 0.99995, enabled: false, precision: 0.7777777777777778, support: 9, precisionLCB95: 0.45035835049338985),
        ...
        "ru/para/PARA_BREAK/unknown": Cell(threshold: 0.99995, enabled: false, precision: 0.7777777777777778, support: 9, precisionLCB95: 0.45035835049338985),
        "ru/punct/!": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "ru/punct/,": Cell(threshold: 0.995, enabled: false, precision: 0.6774193548387096, support: 31, precisionLCB95: 0.5145839256004521),
        "ru/punct/.": Cell(threshold: 0.62, enabled: true, precision: 0.6160714285714286, support: 112, precisionLCB95: 0.5343528815502702),
        "ru/punct/:": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "ru/punct/;": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "ru/punct/?": Cell(threshold: 0.3, enabled: false, precision: 0.5, support: 2, precisionLCB95: 0.025320565519103607),
        "ru/punct/ALL": Cell(threshold: 0.9997, enabled: false, precision: 0.7843137254901961, support: 51, precisionLCB95: 0.6683373479579642),
        "ru/punct/NONE": Cell(threshold: 0.76, enabled: false, precision: 0.47368421052631576, support: 19, precisionLCB95: 0.27394584508232006),
