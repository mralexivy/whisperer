...
struct MMBERTCalibrationTable: Sendable {
    ...
    static let measured = MMBERTCalibrationTable(cells: [
        "en/append/ALL": Cell(threshold: 0.961, enabled: false, precision: 0.375, support: 88, precisionLCB95: 0.28866826191684286),
        "en/append/NONE": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/append/a": Cell(threshold: 0.89, enabled: false, precision: 0.24390243902439024, support: 41, precisionLCB95: 0.13871915579652952),
        ...
        "en/append/an": Cell(threshold: 0.991, enabled: false, precision: 0.5714285714285714, support: 7, precisionLCB95: 0.22532158403244773),
        "en/append/any": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/append/are": Cell(threshold: 0.9685, enabled: false, precision: 0.3, support: 10, precisionLCB95: 0.08726443391415033),
        "en/append/as": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/append/at": Cell(threshold: 0.3, enabled: false, precision: 0.5714285714285714, support: 7, precisionLCB95: 0.22532158403244773),
        ...
        "en/append/can": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 1, precisionLCB95: 0.05),
        ...
        "en/append/is": Cell(threshold: 0.3, enabled: false, precision: 0.0, support: 12, precisionLCB95: 0.0),
        ...
        "en/append/on": Cell(threshold: 0.3, enabled: false, precision: 0.5, support: 2, precisionLCB95: 0.025320565519103607),
        ...
        "en/append/the": Cell(threshold: 0.97, enabled: false, precision: 0.41935483870967744, support: 31, precisionLCB95: 0.26882627622322747),
        ...
        "en/append/to": Cell(threshold: 0.3, enabled: false, precision: 1.0, support: 6, precisionLCB95: 0.6069622310029172),
        ...
        "en/case/ALL": Cell(threshold: 0.9995, enabled: false, precision: 0.9824561403508771, support: 57, precisionLCB95: 0.9194582039369227),
        "en/case/CAP": Cell(threshold: 0.51, enabled: true, precision: 0.637997432605905, support: 779, precisionLCB95: 0.608678657343117),
        "en/case/LOWER": Cell(threshold: 0.3, enabled: true, precision: 0.8244274809160306, support: 131, precisionLCB95: 0.76052837073103),
        "en/case/UPPER": Cell(threshold: 0.91, enabled: false, precision: 0.4, support: 5, precisionLCB95: 0.07644039141232889),
        "en/disf/DISF": Cell(threshold: 0.52, enabled: true, precision: 0.4986072423398329, support: 359, precisionLCB95: 0.453937368931294),
        "en/error/ERROR": Cell(threshold: 0.48, enabled: true, precision: 0.7145790554414785, support: 3409, precisionLCB95: 0.7015762925476107),
        "en/merge/ALL": Cell(threshold: 0.88, enabled: false, precision: 1.0, support: 6, precisionLCB95: 0.6069622310029172),
        "en/merge/MERGE_HYPHEN": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/merge/MERGE_SPACE": Cell(threshold: 0.88, enabled: false, precision: 1.0, support: 6, precisionLCB95: 0.6069622310029172),
        ...
        "en/para/ALL": Cell(threshold: 0.9935, enabled: false, precision: 0.5833333333333334, support: 12, precisionLCB95: 0.3152377907244521),
        ...
        "en/para/PARA_BREAK": Cell(threshold: 0.72, enabled: false, precision: 0.4827586206896552, support: 29, precisionLCB95: 0.32029626073802414),
        ...
        "en/para/PARA_BREAK/editor": Cell(threshold: 0.3, enabled: false, precision: 0.0, support: 2, precisionLCB95: 0.0),
        "en/para/PARA_BREAK/messaging": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/para/PARA_BREAK/unknown": Cell(threshold: 0.72, enabled: false, precision: 0.5185185185185185, support: 27, precisionLCB95: 0.3469716996903496),
        "en/punct/!": Cell(threshold: 0.69, enabled: false, precision: 0.6, support: 5, precisionLCB95: 0.1892553774377708),
        "en/punct/,": Cell(threshold: 0.9755, enabled: false, precision: 0.6773049645390071, support: 282, precisionLCB95: 0.6284882399724426),
        "en/punct/.": Cell(threshold: 0.3, enabled: true, precision: 0.7610015174506829, support: 1318, precisionLCB95: 0.7408778534285589),
        "en/punct/:": Cell(threshold: 0.89, enabled: false, precision: 0.4, support: 5, precisionLCB95: 0.07644039141232889),
        "en/punct/;": Cell(threshold: 0.74, enabled: false, precision: 0.16666666666666666, support: 6, precisionLCB95: 0.008512444610847119),
        "en/punct/?": Cell(threshold: 0.3, enabled: true, precision: 0.7619047619047619, support: 42, precisionLCB95: 0.6296824633328466),
        "en/punct/ALL": Cell(threshold: 0.998, enabled: false, precision: 0.9101123595505618, support: 534, precisionLCB95: 0.8870837825508199),
        "en/punct/NONE": Cell(threshold: 0.9825, enabled: false, precision: 0.6, support: 5, precisionLCB95: 0.1892553774377708),
        "en/punct/—": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/punct/…": Cell(threshold: 0.58, enabled: false, precision: 0.4, support: 5, precisionLCB95: 0.07644039141232889),
        "en/repl/ALL": Cell(threshold: 0.992, enabled: false, precision: 0.8888888888888888, support: 18, precisionLCB95: 0.6897372603017891),
        "en/repl/CONTRACT": Cell(threshold: 0.78, enabled: true, precision: 0.875, support: 8, precisionLCB95: 0.5293205913988683),
        ...
        "en/repl/VERB_3SG": Cell(threshold: 0.964, enabled: true, precision: 1.0, support: 11, precisionLCB95: 0.7615958096191473),
        "en/repl/VERB_ING": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "en/repl/VERB_PAST": Cell(threshold: 0.9635, enabled: false, precision: 0.6666666666666666, support: 12, precisionLCB95: 0.39086230177096337),
        ...
        "he/case/ALL": Cell(threshold: 0.89, enabled: false, precision: 0.6666666666666666, support: 3, precisionLCB95: 0.13535036217158378),
        "he/case/CAP": Cell(threshold: 0.3, enabled: false, precision: 0.0, support: 1, precisionLCB95: 0.0),
        "he/case/LOWER": Cell(threshold: 0.3, enabled: false, precision: 0.42857142857142855, support: 7, precisionLCB95: 0.1287563928042427),
        "he/case/UPPER": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "he/disf/DISF": Cell(threshold: 0.65, enabled: true, precision: 0.6451612903225806, support: 31, precisionLCB95: 0.4817507467611476),
        "he/error/ERROR": Cell(threshold: 0.999, enabled: false, precision: 0.8181818181818182, support: 11, precisionLCB95: 0.5299132007208238),
        ...
        "he/para/ALL": Cell(threshold: 0.998, enabled: false, precision: 0.6829268292682927, support: 41, precisionLCB95: 0.543846754790599),
        ...
        "he/para/PARA_BREAK": Cell(threshold: 0.998, enabled: false, precision: 0.6829268292682927, support: 41, precisionLCB95: 0.543846754790599),
        ...
        "he/para/PARA_BREAK/unknown": Cell(threshold: 0.998, enabled: false, precision: 0.6829268292682927, support: 41, precisionLCB95: 0.543846754790599),
        "he/punct/!": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "he/punct/,": Cell(threshold: 0.8, enabled: false, precision: 0.25, support: 44, precisionLCB95: 0.1469819455083332),
        "he/punct/.": Cell(threshold: 0.994, enabled: false, precision: 0.5454545454545454, support: 22, precisionLCB95: 0.3525440815834854),
        "he/punct/:": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "he/punct/;": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "he/punct/?": Cell(threshold: 0.3, enabled: false, precision: 0.0, support: 5, precisionLCB95: 0.0),
        "he/punct/ALL": Cell(threshold: 0.994, enabled: false, precision: 0.42424242424242425, support: 33, precisionLCB95: 0.2777487520243494),
        "he/punct/NONE": Cell(threshold: 0.967, enabled: false, precision: 0.3888888888888889, support: 18, precisionLCB95: 0.19895329584249163),
        "he/punct/—": Cell(threshold: 0.57, enabled: false, precision: 0.2, support: 5, precisionLCB95: 0.010206218313011496),
        "he/punct/…": Cell(threshold: 0.3, enabled: false, precision: 0.3333333333333333, support: 6, precisionLCB95: 0.06284989170835438),
        ...
        "ru/case/ALL": Cell(threshold: 0.9992, enabled: false, precision: 0.7666666666666667, support: 30, precisionLCB95: 0.6060525774776367),
        "ru/case/CAP": Cell(threshold: 0.982, enabled: true, precision: 0.569620253164557, support: 79, precisionLCB95: 0.4708737964666696),
        "ru/case/LOWER": Cell(threshold: 0.3, enabled: true, precision: 0.9, support: 10, precisionLCB95: 0.6058366975634952),
        "ru/case/UPPER": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "ru/disf/DISF": Cell(threshold: 0.3, enabled: false, precision: 0.43333333333333335, support: 30, precisionLCB95: 0.27866957384161106),
        "ru/error/ERROR": Cell(threshold: 0.94, enabled: true, precision: 0.7540322580645161, support: 248, precisionLCB95: 0.7048860511466704),
        ...
        "ru/para/ALL": Cell(threshold: 0.999, enabled: false, precision: 0.9090909090909091, support: 11, precisionLCB95: 0.6356405107527575),
        ...
        "ru/para/PARA_BREAK": Cell(threshold: 0.9915, enabled: true, precision: 0.8235294117647058, support: 17, precisionLCB95: 0.6043585665551789),
        ...
        "ru/para/PARA_BREAK/unknown": Cell(threshold: 0.9915, enabled: true, precision: 0.8235294117647058, support: 17, precisionLCB95: 0.6043585665551789),
        "ru/punct/!": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "ru/punct/,": Cell(threshold: 0.9985, enabled: false, precision: 0.9130434782608695, support: 23, precisionLCB95: 0.7507512501797403),
        "ru/punct/.": Cell(threshold: 0.48, enabled: true, precision: 0.6456692913385826, support: 127, precisionLCB95: 0.5698673262860819),
        "ru/punct/:": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "ru/punct/;": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "ru/punct/?": Cell(threshold: 0.68, enabled: false, precision: 0.4, support: 5, precisionLCB95: 0.07644039141232889),
        "ru/punct/ALL": Cell(threshold: 0.9992, enabled: false, precision: 0.9148936170212766, support: 47, precisionLCB95: 0.8157350147264736),
        "ru/punct/NONE": Cell(threshold: 0.9675, enabled: false, precision: 0.4, support: 5, precisionLCB95: 0.07644039141232889),
        "ru/punct/—": Cell(threshold: nil, enabled: false, precision: nil, support: 0, precisionLCB95: nil),
        "ru/punct/…": Cell(threshold: 0.3, enabled: false, precision: 0.25, support: 4, precisionLCB95: 0.012741455098566192),
