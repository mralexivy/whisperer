...
class DictionaryManager: ObservableObject {
    ...
    private init() {
        ...
        Task.detached { [weak self] in
            ...
            let packPrefs = self.packPreferences
            let loadedPacks = await Self.loadPacksInBackground(packPreferences: packPrefs)
            ...
            await Self.loadBundledDictionaryInBackground(packs: loadedPacks, packPreferences: packPrefs)
